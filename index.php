        ...
        <div class="scren2" id="Welcome">
            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col d-flex align-items-center shadowMy">
                        <img class="img-fluid _img2s1 rig" src="..\img\1622492032_20-p-luchshie-intereri-derevyannikh-domov-20.jpg" alt="">
                    </div>
            ...
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col d-flex align-items-center shadowMy">
                        <img class="img-fluid _img2s1 lef" src="..\img\restoran-rapsodija-1.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class=" row po1">
            ...
            <div class="container text-center mt-5">
                <div class="row">
                    <div class="col d-flex align-items-center shadowMy">
                        <img class="img-fluid _img2s1 rig" src="..\img\voto67.jpg" alt="">
                    </div>
                    <div class="col mr-5 d-flex align-items-center" style="margin-right: 3%;">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="..\img\2e579c7c6d9e865b3edc6de902a0ff5c.jpg" class="d-block sizing" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="..\img\1645050566_12-fikiwiki-com-p-les-krasivie-kartinki-12.jpg" class="d-block sizing" alt="...">
                      </div>
                      <div class="carousel-item">
                ...
                <div class="fon_con pb-5 pt-5">
                    <div class="container textOswald mb-4 mt-5">
                        <div class="row row-cols-1 row-cols-md-3 g-5">
                            ...
                            <div class="col">
                              <div class="card">
                                <img src="..\img\1648945674_71-vsegda-pomnim-com-p-panoramnii-dom-v-lesu-foto-72.jpg" class="card-img-top" alt="...">
                            ...
                            <div class="col">
                              <div class="card">
                                <img src="..\img\b8c2ccc0ffb85b20703599ad9f16816d.jpeg" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                            ...
                            <div class="col">
                              <div class="card">
                                <img src="..\img\1616735276_1-p-interer-domika-v-lesu-1.jpg" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                            ...
                            <div class="col">
                              <div class="card">
                                <img src="..\img\1616735279_30-p-interer-domika-v-lesu-32.jpg" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                  <img src="..\img\1648945598_53-vsegda-pomnim-com-p-panoramnii-dom-v-lesu-foto-53.jpg" class="card-img-top" alt="...">
                                  <div class="card-body text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                  <img src="..\img\1616735362_29-p-interer-domika-v-lesu-31.jpg" class="card-img-top" alt="...">
                                  <div class="card-body text-center">
                        ...
                        <div class="d-grid gap-1 col-2 mx-auto pb-5">
                            <a class="btn btn-outline-light" href="#" >Показать ещё</a>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="d-flex flex-row justify-content-between align-items-center">
            ...
            <div class="kont_fut">
              ...
              <div class="con_icon d-flex justify-content-center">
                <img class="ic_vk" src="..\img\vk.png" alt="">
                <img class="ic_you" src="..\img\youtube.png" alt="">
              </div>
            </div>
          </div>
          <div class="kopir">
